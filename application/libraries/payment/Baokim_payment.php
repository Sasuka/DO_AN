...
class BaoKim_payment
{
    ...
    var $code = 'baokim';
    var $setting = array(
        'business' => 'tientai206@gmail.com',//tai khoan cua nguoi nhan tien
        'merchant_id' => '30089',//id cua website khi dang ky ben baokim
        'secure_pass' => '1a3ca85fd2d719d4',//mat khau giao tiep
        'cost_constant' => 1700,
        'cost_percent' => 1,
    );
     ...
     */
    function result1($tran_id, $amount)
    {
    ...
    function result($tran_id, $amount)
    {
        ...
        $this->CI->load->model('transactionDetail_model');
        $data = array();
        $data['payment_info'] = serialize($result);
        $tran_id = array('MA_GIAODICH' => $tran_id);
        $this->CI->transactionDetail_model->update_rule($tran_id, $data);
